...
public class OrganizerProfile extends AppCompatActivity {
    ...
    AppCompatButton BTEditOrgProfile, BTLogOut;
    MaterialButton BTProfileBack, MBAboutUs;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MBAboutUs = findViewById(R.id.MBAboutUs);
        ...
        MBAboutUs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OrganizerProfile.this, AboutUs.class);
        ...
        BTLogOut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OrganizerProfile.this, LogInOrganizer.class);
                startActivity(intent);
                finish();
            }
        });
